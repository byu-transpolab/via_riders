...
the failure of Kutsusplus [@weckstrom2018]. At the same time, this finding could 
have been influenced by the reduced fare durint the initial rollout period. 
The significant findings --- a 
...
*overrepresented*. Does this mean that members of this older group could be a 
...
[@uta2020boardings]. Total system ridership was remarkably stable during
