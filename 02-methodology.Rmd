...
period \DIFadd{; approximately 60\% of the surveys in both tranches were collected between 4 and 7 PM.} \DIFdel{The number of interviews conducted during each time period for each tranche is shown in Table 1.}

\DIFdel{Previous Table 1}
